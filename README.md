...
Υλικά
Ένας Αισθητήρας Υγρασίας 
Ένας Αισθητήρας φωτεινότητας και απόστασης
Ποτήρι με χώμα και φυτό
Μικροελεγκτές Arduino  2 τεμάχια
Δύο Breadboard, καλώδια, αντιστάσεις,led
Ένα μακετόχαρτο, ψαλίδια,μαρκαδόρους, κολλητήρι, πινέλα, μακέτα, χόρτα , γλωσσοπίεστρα  κ.λπ.
